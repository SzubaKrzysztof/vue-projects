<template>
    <main class="main">
        <page-header title="Blog Masonry With Sidebar" subtitle="Blog"></page-header>
        ...
        <div class="page-content">
            <div class="container-fluid" v-images-loaded.on="handleIsotope">
                    ...
                    <div class="col-lg-9">
                        ...
                        >
                            <div
                                ...
                                :key="index"
                            >
                                <blog-one :blog="blog" class="text-center"></blog-one>
                            </div>
                        </isotope>
