    ...
    <div class="product text-center">
        <figure class="product-media">
            ...
            <div class="product-action-vertical" v-if="product.stock !== 0">
                ...
                <a
                    href="javascript:;"
                    class="btn-product-icon btn-compare added-to-compare d-none d-sm-flex"
                    title="Compare"
                ...
                <a
                    href="#"
                    class="btn-product-icon btn-compare d-none d-sm-flex"
                    title="Compare"
        ...
        <div class="product-body">
            ...
            <count-down
                ...
                format="DHMS"
                :labels-short="true"
                v-if="product.until && new Date(product.until) > new Date()"
            ></count-down>
        </div>
    </div>
</template>
